...
import { options, useExportProductChartStore } from "./chart";
...
const ExportProductChart = () => {
  const state = useExportProductChartStore((state) => state);
...
export default ExportProductChart;
