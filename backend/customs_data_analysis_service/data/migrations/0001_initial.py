    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='region', to='data.districtdestination', verbose_name='Округ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('netto', models.FloatField(verbose_name='Вес')),
                ...
                ('measurement_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='operation', to='data.measurementunit', verbose_name='Единица измерения')),
